    ...
    <div className='col-sm-10 col-md-4 text-center mx-auto'>
        <ul className="listD">
            <li className='my-3' ><span className='h6'>
                            ...
                            </svg> Dirección:Valentín Vergara 1557, Banfield</span></li>
            <li className='my-3' ><span className='h6'>
                ...
                </svg> Telefono: (+549) 1162343318 </span></li>
...
<div className='col-sm-10 col-md-4  text-center mx-auto'>
    <ul className="listD">
        ...
        <li className='my-3' ><a href="#contacto"  className=' text-dark'style={{ textDecoration: 'none' }}> <span className='h6'> Contacto</span></a></li>
        <li className='my-3' ><a href="#conoceme"  className=' text-dark'style={{ textDecoration: 'none' }}> <span className='h6'> Conoceme</span></a></li>
    </ul>


</div>
</div>
<div className='text-center text-dark servicios mx-auto col-10 '><span> @copyrigth nicolasruiz -2022 </span></div>
